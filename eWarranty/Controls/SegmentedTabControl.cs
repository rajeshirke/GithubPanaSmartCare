...
namespace eWarranty.Controls
{
    public class SegmentedTabControl : Grid
    {
        public static readonly BindableProperty TintColorProperty =
            BindableProperty.Create(nameof(TintColor), typeof(Color), typeof(SegmentedTabControl), Color.FromHex("#EA1D24"), propertyChanged: HandleTintColorPropertyChanged);
        ...
        public static readonly BindableProperty UnselectedSegmentTextColorProperty =
            BindableProperty.Create(nameof(UnselectedSegmentTextColor), typeof(Color), typeof(SegmentedTabControl), Color.White, propertyChanged: HandleUnselectedSegmentTextColorPropertyChanged);
        ...
        private static void HandleUnselectedSegmentTextColorPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            for (var i = 0; i < control.Children.Count(); i++)
            {
                ...
                if (i != control.SelectedSegment)
                {
                    ...
                    {
                        // Update it's text color
                        label.TextColor = Color.White;//  (Color)newValue;
                    }
                }
            }
        }
        ...
        public SegmentedTabControl()
        {
            ...
            UnselectedSegmentTextColor = Color.White;
        }
        ...
        private void UpdateSelectedItem(int key)
        {
            for (var i = 0; i < Children.Count(); i++)
            {
                ...
                if (label != null)
                {
                    ...
                    label.TextColor = Color.White;// UnselectedSegmentTextColor;
                }
            }
