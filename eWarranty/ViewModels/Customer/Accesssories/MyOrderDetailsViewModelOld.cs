...
{
    public class MyOrderDetailsViewModelOld : BaseViewModel
    {
        DateTime FutureDate;
        public MyOrderDetailsViewModelOld(INavigation navigation, OrderListResponse order) : base(navigation)
        {
        ...
        public MyOrderDetailsViewModelOld(INavigation navigation, OrderDetailResponse orderDetailResponse) : base(navigation)
        {
        ...
        public int OrderDetailsLength
        {
            get
            {
                if (Device.RuntimePlatform == Device.Android)
                    _OrderDetailsLength = OrderDetails.Count * 250;
                else if (Device.RuntimePlatform == Device.iOS)
                    _OrderDetailsLength = OrderDetails.Count * 225;
                else
                    _OrderDetailsLength = OrderDetails.Count * 225;
