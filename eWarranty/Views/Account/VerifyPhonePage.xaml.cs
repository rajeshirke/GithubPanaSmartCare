...
namespace eWarranty.Views.Account
{
    public partial class VerifyPhonePage : ContentPage
    {
        ...
        public VerifyPhonePage(string pageName)
        {
            ...
            string emailmsg = "Please verify your account with the code sent at ";
            ...
            btnVerfy.IsEnabled = false;
            btnVerfy.BackgroundColor = Color.LightGray;
        ...
        public void checkOtpnumber()
        {
            ...
            {
                btnVerfy.BackgroundColor = (Color)Application.Current.Resources["BlueColor"];
                btnVerfy.IsEnabled = true;
